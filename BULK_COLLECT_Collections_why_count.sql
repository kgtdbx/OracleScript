...
https://livesql.oracle.com/apex/livesql/file/content_DG4IIPR54VJMUBD4TOEGH8MC8.html
Description
This script demonstrates key characteristics of a collection populated by a BULK COLLECT fetch: it is either empty or sequentially filled from index value 1.
Category
PL/SQL General
Contributor
...
LAST=107
COUNT=107
FIRST=LAST is NULL when collection is empty
LAST=LAST is NULL when collection is empty
COUNT=0
Low and high in FOR loop must be non-NULL!
FIRST=1
LAST=25
COUNT=25