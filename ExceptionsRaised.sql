/*
Exceptions Raised in Declaration Section Not Handled LocallyView All Scripts Login and Run Script
Script Name
...
--Statement 2
--Can't trap the exception in the same block (when raised in the declaration section), but certainly it is trappable in an outer block.
