...
Description
Here's a package that makes it easy to manage lists of lists, using a nested collection and a string indexed collection.
Category
PL/SQL General
Contributor
...
Statement 4
Syntax for nested collections can be hard to read. I encourage you to take your time, go through this code line by line, and make sure you understand the moving parts.
...
Statement 5
Create a constant with the list name to avoid multiple, hard-coded references. Notice the use of the subtype declared in the string_tracker package to declare the list name.
Exercise the API
