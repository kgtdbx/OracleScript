...
IS
   ...
   BEGIN
      ...
      DBMS_OUTPUT.put_line (
         '> owner ' || utl_call_stack.owner (depth_in));
      ...
      DBMS_OUTPUT.put_line (
            '> lexical_depth '
         || utl_call_stack.lexical_depth (depth_in));
      DBMS_OUTPUT.put_line (
         '> unit_line ' || utl_call_stack.unit_line (depth_in));
      DBMS_OUTPUT.put_line (
            '> current_edition '
         || utl_call_stack.current_edition (depth_in));
   END;
   ...
   BEGIN
      ...
      DBMS_OUTPUT.put_line (
            '> backtrace_unit '
         || utl_call_stack.backtrace_unit (depth_in));
      DBMS_OUTPUT.put_line (
            '> backtrace_line '
         || utl_call_stack.backtrace_line (depth_in));
   END;
